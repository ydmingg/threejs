...
const vertices = new Float32Array([
  ...
  3.0, -1.0, 0.0,5.0, -1.0, 0.0,5.0, 1.0, 0.0,3.0,1.0,0.0 // 统一加4
])
// 设置顶点属性
...
///////////////// 顶点移动（当顶点开始就偏离原点的情况下使用，其他使用物体移动）
gGeometry.translate(-4,0,0) // 顶点移动了，打印元素的属性去看position
// 旋转
gGeometry.rotateX(Math.PI / 2)
// 缩放
gGeometry.scale(0.5,0.5,0.5)
